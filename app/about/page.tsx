...
const PILLARS = [
  ...
  },
  {
    ...
    desc: "تحلیل‌های ساختاریافته و تأییدشدهٔ این پلتفرم با ذکر فروض و دادهٔ پشتوانه منتشر می‌شوند؛ ارزش‌گذاری‌ها بازه‌ای و سناریومحورند، نه عدد قطعی — و در کارنامهٔ عمومی قابل پیگیری‌اند.",
  },
  {
        ...
        <section className="section" style={{ background: "var(--bg)" }}>
          <div className="mx-auto w-full max-w-4xl px-5 text-center">
            ...
            <p className="text-base mb-8" style={{ color: "var(--text-2)" }}>
              کارنامهٔ عمومی را بررسی کنید یا درخواست خود را ثبت کنید.
            </p>
