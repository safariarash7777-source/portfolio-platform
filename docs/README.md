...
| [`PRODUCT-BLUEPRINT.md`](./PRODUCT-BLUEPRINT.md) | قطب‌نمای محصول | مقصد، ۵ ناحیه، مرزِ رایگان/پرمیوم، نقشهٔ فاز |
...
**هرگز مبنای کارِ جدید نیستند**: `MASTER-PLAN` · `ROADMAP` (v1) ·
`AUDIT-FIX-BRIEF` · `TASK-relay-deploy` · `competitor-notes` · `i1-fameli-1404` ·
`content-hub`
