...
| **Portfolio main SHA** | `51ac8aa4bb19d7eff9a7e2d9fe2683e2bdb0e38a` — **verified as of 2026-07-27**. این مقدار ذاتاً کهنه می‌شود؛ منبعِ حقیقت `git rev-parse origin/main` است، نه این خانه. مسیر: `aaf9974` → `57100c5` (#76) → `1261383` (#77) → `b606176` (#78) → `0023f6f` (#80) → `51ac8aa` (#79) | VERIFIED |
