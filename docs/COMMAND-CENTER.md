...
| **#121** | فهرستِ توانمندی + نمونهٔ طراحی + تفکیکِ نمادِ متوقف | `7062994` | `614b59d` (به‌روز) | محلی سبز · CI هنوز شلیک نشده | بستهٔ بودجهٔ این برنچ **با #127 هم‌پوشان شد و کنار گذاشته شد**؛ آنچه ماند `symbolLiveness` + `phase29` + اسناد | بازبینی |
