...
| **Portfolio main SHA** | `aaf9974841cc35e543162919366f8f61e518fcf9` | VERIFIED (`git rev-parse origin/main`) |
...
|---|---|---|---|---|---|---|---|
| **G-001** | Portfolio PR #76 Review Gate | Portfolio | PR باز، diff محدود به حذفِ دو workflow | بازبینی PASS · mergeable=clean · تأییدِ آرش · merge | **READY_FOR_MERGE** (منتظرِ تأیید) | ARASH | B-011 |
| **G-002** | Portfolio PR #77 Review Gate | Portfolio | PR باز، فقط docs | بازبینی PASS · اسناد منطبق بر واقعیت · تأییدِ آرش · merge | **IN_REVIEW** | ARASH | B-012 |
...
| **B-011** | PR #76 هنوز merge نشده | 🟢 LOW | Portfolio | ARASH | 2026-07-24 | G-001، DD-008 | تأیید و merge توسط آرش | GitHub: state=open، draft=true، mergeable_state=clean | **OPEN** · VERIFIED |
| **B-012** | PR #77 هنوز merge نشده | 🟢 LOW | Portfolio | ARASH | 2026-07-24 | G-002 | تأیید و merge توسط آرش | GitHub: state=open، draft=true | **OPEN** · VERIFIED |
...
| **B-015** | پس از merge شدنِ PR #76، مخزن **هیچ GitHub Actions workflowی** نخواهد داشت | 🟡 MEDIUM | Portfolio / CI | ARASH | 2026-07-25 | پوششِ CI | تصمیم: آیا یک workflowِ واقعیِ CI (build/typecheck/test) اضافه شود؟ | `.github/workflows/` فقط همان دو فایل را دارد؛ test-merge نشان داد پوشه خالی می‌شود | **OPEN** · VERIFIED |
...
| ریشه‌یابیِ هشدارِ `docs/ONBOARDING.md` | **RESOLVED** — عدمِ تطابقِ شاخه، نه نقصِ مخزن | بخشِ «هشدارِ ONBOARDING» در `ONBOARDING.md` | 2026-07-25 |
