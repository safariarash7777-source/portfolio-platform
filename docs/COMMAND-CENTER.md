...
| **#156** همان #113، هم‌تراز با `main` | `fbb627e` | `main` | `2fc7f50` ۷/۷ ولی **گیت بی‌اثر بود** (پایین)؛ اجرای `fbb627e` در جریان | آمادهٔ بازبینی · `HOLD_BY_OWNER` پابرجا | بدونِ تعارض؛ `MIN_PASS=417` از کلاسترِ نو |
| **#157** کاربرگِ پژوهش: ذخیره، بازکردن، نسخهٔ دوم، تأییدِ داخلی (#142) | `819cbf1` | `main` | در جریان | آمادهٔ بازبینی | `phase34` **اجرا نشده** (دروازهٔ بکاپ)؛ تا آن موقع API ۵۰۳ صادق و صفحه روی مسیرِ فایل |
