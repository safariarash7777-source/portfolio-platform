...
## 0″. ایستگاه تحویل و قاعدهٔ گزارش به آرش

نقطهٔ ورودِ کوتاه بینِ چت‌ها: [issue #145](https://github.com/safariarash7777-source/portfolio-platform/issues/145) — جایگزینِ این سند نیست، ورودی‌اش است. در شروعِ هر نوبت، آخرین نظرهای آن و وضعیتِ `main` خوانده شود؛ نتیجهٔ پایانِ هر نوبت در issueِ کاریِ مربوط ثبت شود. متنِ چت به‌تنهایی مرجعِ تحویل نیست.

گزارش به آرش فارسی، کوتاه و با نتیجهٔ قابلِ لمس است. اصطلاحِ ضروری در همان جمله فارسی توضیح داده می‌شود. شمارهٔ PR/SHA و تعدادِ تست **پیوستِ فنی‌اند، نه تیترِ وضعیت**.

قالبِ ثابت: «چه چیزی الان کار می‌کند / چه چیزی هنوز کار نمی‌کند / اقدامِ بعدی و مسئول / تنها تصمیم یا دسترسیِ ضروریِ آرش».

توسعه: Claude · بازبینیِ شواهد و پذیرش: Codex. هیچ‌کدام بیرون از نوبتِ فعال، مانیتورِ دائمی فرض نمی‌شوند.
