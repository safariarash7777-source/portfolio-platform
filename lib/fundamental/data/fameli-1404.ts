...
// منبع: docs/i1-fameli-1404.md (استخراج مستقیم از PDF رسمی کدال + چک‌های حسابی
...
export const FAMELI_N10_SOURCE: ReportSource = {
  ...
  verified: true,
  verification_note:
    "اعتبارسنجی متقاطع: جمع اجزای سود، EPS = سود ÷ سرمایه، تطبیق با جدول روند ۵ساله و تقسیم سود (docs/i1-fameli-1404.md §۸)",
};
