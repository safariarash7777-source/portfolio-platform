...
const ITEMS = [
  ...
  },
  {
    ...
    a: "در هر زمان از داشبورد کاربری خود می‌توانید اشتراک را لغو کنید. هیچ پنالتی یا کسری وجود ندارد و دسترسی شما تا پایان دوره فعلی برقرار خواهد ماند.",
  },
];
