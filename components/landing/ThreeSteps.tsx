...
const STEPS = [
  {
    ...
    desc: "در ۶ بخش رفتاری و مالی، سطح تحمل ریسک، افق زمانی و اهداف شما دقیق مشخص می‌شود.",
  },
  {
    num: "۰۲",
    icon: <PieChart size={22} />,
    title: "ساختار متناسب با پروفایل",
    desc: "نتیجهٔ آزمون، نمونهٔ ساختار دارایی متناسب با پروفایل شما را نشان می‌دهد؛ طراحی سبد اختصاصی در جلسهٔ مشاوره انجام می‌شود.",
  },
  {
    num: "۰۳",
    icon: <Send size={22} />,
    title: "همراهی و به‌روزرسانی",
    desc: "هشدار قیمت و یادداشت‌های تحلیلی را در تلگرام دنبال کنید؛ در دورهٔ مشاوره، بازنگری سبد نیز همراه شماست.",
  },
];
