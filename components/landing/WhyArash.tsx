 ...
 *  - «کارنامهٔ عمومی» (واقعی — داده از جدول signals)
 */
const PILLARS = [
  {
  ...
  },
  {
    ...
    desc: "هر تحلیل با ذکر فروض و دادهٔ پشتوانه منتشر می‌شود؛ ارزش‌گذاری‌ها بازه‌ای و سناریومحورند، نه عدد قطعی — و در کارنامهٔ عمومی قابل پیگیری.",
  },
  {
  ...
  {
    icon: <Eye size={22} />,
    title: "کارنامهٔ عمومی",
    desc: "هر تحلیل با قیمت ورود، تاریخ و نتیجه ثبت می‌شود — برای همه قابل مشاهده.",
  },
];
