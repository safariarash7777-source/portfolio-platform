...
const ITEMS = [
  ...
  },
  {
    ...
    a: "داده‌های شما روی زیرساخت ابری امن، با ارتباط و ذخیره‌سازی رمزنگاری‌شده نگهداری می‌شود. اطلاعات شما به هیچ شخص ثالثی فروخته یا واگذار نمی‌شود و در هر زمان می‌توانید درخواست حذف کامل داده‌های خود را ثبت کنید.",
  },
  {
  ...
  },
  {
    ...
    a: "بله. هر تحلیلی که در پلتفرم منتشر می‌شود، با ذکر فروض و داده‌های پشتوانهٔ آن همراه است؛ ارزش‌گذاری‌ها همیشه به‌صورت بازه و با سناریوهای مشخص ارائه می‌شوند، نه عدد قطعی. تحلیل‌های منتشرشده هم در «کارنامه» با مهر زمانی ثبت می‌شوند و نتیجهٔ‌شان قابل پیگیری است.",
  },
  {
