...
const ITEMS = [
  ...
  },
  {
    ...
    a: "داده‌های شما روی زیرساخت ابری نگهداری می‌شود و فقط برای ارائهٔ خدمت استفاده می‌شود. برای جزئیات حریم خصوصی و نحوهٔ درخواست حذف داده‌ها، با پشتیبانی تماس بگیرید.",
  },
  {
  ...
  },
  {
    ...
    a: "ابتدا ثبت‌نام کنید و آزمون پروفایل ریسک را تکمیل کنید؛ نتیجهٔ پروفایل و نمونهٔ ساختار دارایی متناسب با آن را همان‌جا می‌بینید. طراحی سبد اختصاصی، در جلسهٔ مشاوره با آرش صفری و بر اساس شرایط واقعی شما انجام می‌شود.",
  },
];
