      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-7" style={{ color: "var(--text-3)" }}>
            مرجعِ دادهٔ همهٔ دارایی‌ها: نمادهای بورس و فرابورس، صندوق‌های سرمایه‌گذاری (طلا، اهرمی، درآمد ثابت، کالایی و سهامی)،
            طلا و ارز — با جستجو، مرتب‌سازی، صفحهٔ جزئیات و خروجی CSV تاریخچه برای هر نماد. دادهٔ ناموجود با «—» نمایش داده می‌شود.
            برای دیده‌بانی لحظه‌ای تابلو، نقشه و شاخص‌ها به{" "}
            <Link href="/market/stocks" className="font-bold hover:underline" style={{ color: "var(--navy)" }}>
              تابلوی سهام
            </Link>{" "}
            بروید.
          </p>
